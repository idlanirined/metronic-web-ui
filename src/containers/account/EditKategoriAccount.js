...
export default function EditKategoriAccount(props) {
    ...
    const handleEdit = () => {
        headOffice('editCategoryAccount', newData)
        props.getData()
        props.onClose()
    }
                ...
                <div className="popup-panel grid grid-2x" style={{ height: 64 }}>
                    <div className="col-1" style={{ maxWidth: "inherit", display: 'flex', alignItems: 'center' }}>
                        <div className="popup-title">
                            <span style={{ color: 'black', fontSize: 18, fontWeight: 'bold' }}>Edit Kategori Account</span>
                        </div>
                    </div>
