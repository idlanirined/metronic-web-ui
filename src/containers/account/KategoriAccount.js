...
import AddKategoriAccount from './AddKategoriAccount';
import EditKategoriAccount from './EditKategoriAccount';
...
export default function KategoriAccount() {
    ...
    const getData = () => {
        ...
        if (dataHeadOffice != null) {
            let newDataCategoryAccount = dataHeadOffice.category_account.map((item, index) => {
    ...
    return (
        <div>
            <div style={{ backgroundColor: '#FEFEFE', padding: '15px 20px' }}>
                <Typography style={{ color: 'black', fontSize: 16, fontWeight: 'bold' }}>Kategori Account</Typography>
            </div>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', padding: 20 }}>
                        ...
                        <div style={{ display: 'flex' }}>
                            ...
                            <div
                                ...
                                <Typography style={{ color: 'white', fontSize: 16, fontWeight: '500', textAlign: 'center', alignSelf: 'center' }}>Tambah Kategori Account</Typography>
                            </div>
                        </div>
                    </div>
                ...
                <div className="App app-popup-show">
                    <div className="popup-content background-white" style={{ borderRadius: 8, backgroundColor: 'white' }}>
                        <div className="popup-panel grid grid-2x" style={{ height: 64 }}>
                            <div className="col-1" style={{ maxWidth: "inherit", display: 'flex', alignItems: 'center' }}>
                                <div className="popup-title">
                                    <span style={{ color: 'black', fontSize: 18, fontWeight: 'bold' }}>Hapus Kategori Account</span>
                                </div>
                            </div>
                        ...
                        <div className="grid grid-2x grid-mobile-none gap-15px" style={{ padding: 20, paddingRight: 50, paddingLeft: 50 }}>
                            ...
                            <div style={{ justifySelf: 'flex-end', width: 'inherit' }}>
                                <div onClick={() => {
                                    headOffice('deleteCategoryAccount', dataSelected)
                                    getData()
