...
export default function EditGolonganBarang(props) {
    ...
    const handleEdit = () => {
        headOffice('editGolongan', newData)
        props.getData()
        props.onClose()
    }
                ...
                <div className="popup-panel grid grid-2x" style={{ height: 64 }}>
                    <div className="col-1" style={{ maxWidth: "inherit", display: 'flex', alignItems: 'center' }}>
                        <div className="popup-title">
                            <span style={{ color: 'black', fontSize: 18, fontWeight: 'bold' }}>Edit Golongan Barang</span>
                        </div>
                    </div>
