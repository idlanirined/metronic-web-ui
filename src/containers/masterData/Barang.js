    ...
    return (
        <div>
            <div style={{ backgroundColor: '#FEFEFE', padding: '15px 20px' }}>
                <Typography style={{ color: 'black', fontSize: 16, fontWeight: 'bold' }}>Daftar Barang</Typography>
            </div>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', padding: 20 }}>
                        ...
                        <div style={{ display: 'flex' }}>
                            ...
                            <div
                                ...
                                <Typography style={{ color: 'white', fontSize: 16, fontWeight: '500', textAlign: 'center', alignSelf: 'center' }}>Add Barang</Typography>
                            </div>
                        </div>
                    </div>
