...
import AddSatuanBarang from './AddSatuanBarang';
    ...
    return (
        <div>
            <div style={{ backgroundColor: '#FEFEFE', padding: '15px 20px' }}>
                <Typography style={{ color: 'black', fontSize: 16, fontWeight: 'bold' }}>Satuan Barang</Typography>
            </div>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', padding: 20 }}>
                        ...
                        <div style={{ display: 'flex' }}>
                            ...
                            <div
                                ...
                                <Typography style={{ color: 'white', fontSize: 16, fontWeight: '500', textAlign: 'center', alignSelf: 'center' }}>Tambah Satuan Barang</Typography>
                            </div>
                        </div>
                    </div>
                ...
                <div className="App app-popup-show">
                    <div className="popup-content background-white" style={{ borderRadius: 8, backgroundColor: 'white' }}>
                        ...
                        <div className="grid grid-2x grid-mobile-none gap-15px" style={{ padding: 20, paddingRight: 50, paddingLeft: 50 }}>
                            ...
                            <div style={{ justifySelf: 'flex-end', width: 'inherit' }}>
                                <div onClick={() => {
                                    headOffice('deleteSatuan', dataSelected)
                                    getData()
