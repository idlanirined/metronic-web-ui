...
import AddAkunUser from './AddAkunUser';
import EditAkunUser from './EditAkunUser';
...
export default function AkunUser() {
    ...
    const columns = [
        { name: "ID USER", options: { filterOptions: { fullWidth: true } } },
        "NAMA USER",
        "LEVEL",
        "PEMBUAT",
        "TIMESTAMP",
    ...
    const getData = () => {
        ...
        if (dataHeadOffice != null) {
            let newDataUser = dataHeadOffice.user.map((item, index) => {
                return [item.id, item.name, item.level, item.createdBy, item.createdDate, item.active]
            })
    ...
    return (
        <div>
            <div style={{ backgroundColor: '#FEFEFE', padding: '15px 20px' }}>
                <Typography style={{ color: 'black', fontSize: 16, fontWeight: 'bold' }}>Akun User</Typography>
            </div>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', padding: 20 }}>
                        ...
                        <div style={{ display: 'flex' }}>
                            ...
                            <div
                                ...
                                <Typography style={{ color: 'white', fontSize: 16, fontWeight: '500', textAlign: 'center', alignSelf: 'center' }}>Add User</Typography>
                            </div>
                        </div>
                    </div>
                ...
                <div className="App app-popup-show">
                    <div className="popup-content background-white" style={{ borderRadius: 8, backgroundColor: 'white' }}>
                        <div className="popup-panel grid grid-2x" style={{ height: 64 }}>
                            <div className="col-1" style={{ maxWidth: "inherit", display: 'flex', alignItems: 'center' }}>
                                <div className="popup-title">
                                    <span style={{ color: 'black', fontSize: 18, fontWeight: 'bold' }}>Hapus Akun User</span>
                                </div>
                            </div>
                        ...
                        <div className="grid grid-2x grid-mobile-none gap-15px" style={{ padding: 20, paddingRight: 50, paddingLeft: 50 }}>
                            ...
                            <div style={{ justifySelf: 'flex-end', width: 'inherit' }}>
                                <div onClick={() => {
                                    headOffice('deleteUser', dataSelected)
                                    getData()
