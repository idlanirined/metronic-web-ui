...
export default function Supplier() {
    ...
    const columns = [
        { name: "ID SUPPLIER", options: { filterOptions: { fullWidth: true } } },
        "NAMA SUPPLIER",
        "JENIS SUPPLIER",
        "PEMBUAT",
        "TIMESTAMP",
    ...
    return (
        <div>
            <div style={{ backgroundColor: '#FEFEFE', padding: '15px 20px' }}>
                <Typography style={{ color: 'black', fontSize: 16, fontWeight: 'bold' }}>Akun Supplier</Typography>
            </div>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', padding: 20 }}>
                        ...
                        <div style={{ display: 'flex' }}>
                            ...
                            <div
                                ...
                                <Typography style={{ color: 'white', fontSize: 16, fontWeight: '500', textAlign: 'center', alignSelf: 'center' }}>Add Supplier</Typography>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="popup-panel grid grid-2x" style={{ height: 64 }}>
                            <div className="col-1" style={{ maxWidth: "inherit", display: 'flex', alignItems: 'center' }}>
                                <div className="popup-title">
                                    <span style={{ color: 'black', fontSize: 18, fontWeight: 'bold' }}>Hapus Supplier</span>
                                </div>
                            </div>
