...
export default function PenerimaanBarangSuppKeHead() {
    ...
    const columns = [
        { name: "NO PENERIMAAN", options: { filterOptions: { fullWidth: true } } },
        "TANGGAL PENERIMAAN",
        "NAMA SUPPLIER",
        "NO PO",
        {
                ...
                customBodyRender: (val, tableMeta) => {
                    return (
                        <div style={{ display: 'flex', justifyContent: 'center' }}>
                            <div
                                onClick={() => null}
                                id="basic-button" aria-haspopup="true" aria-controls="basic-menu" style={{ width: 90, height: 40, backgroundColor: '#3699FF', borderRadius: 10, display: 'flex', justifyContent: 'center' }}>
                                <Typography style={{ color: '#ffffff', fontSize: 14, fontWeight: '500', textAlign: 'center', alignSelf: 'center' }}>konfirm</Typography>
                            </div>
                        </div>
                    )
                }
    ...
    return (
        <div>
            <div style={{ backgroundColor: '#FEFEFE', padding: '15px 20px' }}>
                <Typography style={{ color: 'black', fontSize: 16, fontWeight: 'bold' }}>Penerimaan Barang - Supplier Ke Head Office</Typography>
            </div>
                        ...
                        <div style={{ display: 'flex' }}>
                            ...
                            <div
                                onClick={() => history.push({
                                    pathname: '/add-penerimaan-barang-supplier-head'
                                })}
                                style={{ width: 150, height: 50, backgroundColor: '#3699FF', borderRadius: 10, display: 'flex', justifyContent: 'center', cursor: 'pointer' }}>
                                <Typography style={{ color: 'white', fontSize: 16, fontWeight: '500', textAlign: 'center', alignSelf: 'center' }}>Add Material Receive</Typography>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="popup-panel grid grid-2x" style={{ height: 64 }}>
                            <div className="col-1" style={{ maxWidth: "inherit", display: 'flex', alignItems: 'center' }}>
                                <div className="popup-title">
                                    <span style={{ color: 'black', fontSize: 18, fontWeight: 'bold' }}>Hapus Penerimaan Barang</span>
                                </div>
                            </div>
