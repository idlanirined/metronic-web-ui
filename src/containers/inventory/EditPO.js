...
export default function EditPO() {
    ...
    const getData = () => {
        ...
        console.log(dataHeadOffice, location.state.selected);
        if (dataHeadOffice != null) {
            let idx = dataHeadOffice.pre_order.findIndex((val) => val.id === location.state.selected[0])
            setDataTable(dataHeadOffice.pre_order[idx].dataPo)
