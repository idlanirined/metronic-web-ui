...
export default function ReturBarangHeadKeSupp() {
    ...
    return (
        <div>
            <div style={{ backgroundColor: '#FEFEFE', padding: '15px 20px' }}>
                <Typography style={{ color: 'black', fontSize: 16, fontWeight: 'bold' }}>Retur Barang - Head Office ke Supplier</Typography>
            </div>
                ...
                <div style={{ backgroundColor: '#FFFFFF', height: '83vh', borderRadius: 20 }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', padding: 20 }}>
                        ...
                        <div style={{ display: 'flex' }}>
                            ...
                            <div
                                onClick={() => history.push('/tambah-retur-barang-head-spc')}
                        ...
                        <div className="popup-panel grid grid-2x" style={{ height: 64 }}>
                            <div className="col-1" style={{ maxWidth: "inherit", display: 'flex', alignItems: 'center' }}>
                                <div className="popup-title">
                                    <span style={{ color: 'black', fontSize: 18, fontWeight: 'bold' }}>Hapus Retur Barang</span>
                                </div>
                            </div>
