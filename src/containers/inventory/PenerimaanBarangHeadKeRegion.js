...
export default function PenerimaanBarangHeadKeRegion() {
    ...
    return (
        <div>
            <div style={{ backgroundColor: '#FEFEFE', padding: '15px 20px' }}>
                <Typography style={{ color: 'black', fontSize: 16, fontWeight: 'bold' }}>Penerimaan Barang - Head Office ke Region</Typography>
            </div>
                        ...
                        <div style={{ display: 'flex' }}>
                            ...
                            <div
                                onClick={() => history.push({
                                    pathname: '/add-penerimaan-barang-head-region',
